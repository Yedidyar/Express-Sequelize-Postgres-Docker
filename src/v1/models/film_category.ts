...
export type film_categoryCreationAttributes = Optional<film_categoryAttributes, film_categoryOptionalAttributes>;

export class film_category extends Model<film_categoryAttributes, film_categoryCreationAttributes> implements film_categoryAttributes {
  film_id!: number;
  category_id!: number;
  last_update!: Date;
