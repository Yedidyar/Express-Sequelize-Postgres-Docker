...
export type addressOptionalAttributes = "address_id" | "address2" | "postal_code" | "last_update";
...
export class address extends Model<addressAttributes, addressCreationAttributes> implements addressAttributes {
  ...
  removeCustomers!: Sequelize.HasManyRemoveAssociationsMixin<customer, customerId>;
