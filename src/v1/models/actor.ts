...
export type actorCreationAttributes = Optional<actorAttributes, actorOptionalAttributes>;
...
export class actor extends Model<actorAttributes, actorCreationAttributes> implements actorAttributes {
  ...
  removeFilm_id_film!: Sequelize.BelongsToManyRemoveAssociationMixin<film, filmId>;
  removeFilm_id_films!: Sequelize.BelongsToManyRemoveAssociationsMixin<film, filmId>;
