...
export type rentalOptionalAttributes = "rental_id" | "return_date" | "last_update";
export type rentalCreationAttributes = Optional<rentalAttributes, rentalOptionalAttributes>;
