...
export type film_actorCreationAttributes = Optional<film_actorAttributes, film_actorOptionalAttributes>;

export class film_actor extends Model<film_actorAttributes, film_actorCreationAttributes> implements film_actorAttributes {
  actor_id!: number;
  film_id!: number;
  last_update!: Date;
