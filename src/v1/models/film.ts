...
export type filmOptionalAttributes = "film_id" | "description" | "release_year" | "rental_duration" | "rental_rate" | "length" | "replacement_cost" | "rating" | "last_update" | "special_features";
...
export class film extends Model<filmAttributes, filmCreationAttributes> implements filmAttributes {
  ...
  setActor_id_actors!: Sequelize.BelongsToManySetAssociationsMixin<actor, actorId>;
  addActor_id_actor!: Sequelize.BelongsToManyAddAssociationMixin<actor, actorId>;
  addActor_id_actors!: Sequelize.BelongsToManyAddAssociationsMixin<actor, actorId>;
  createActor_id_actor!: Sequelize.BelongsToManyCreateAssociationMixin<actor>;
  removeActor_id_actor!: Sequelize.BelongsToManyRemoveAssociationMixin<actor, actorId>;
  removeActor_id_actors!: Sequelize.BelongsToManyRemoveAssociationsMixin<actor, actorId>;
  hasActor_id_actor!: Sequelize.BelongsToManyHasAssociationMixin<actor, actorId>;
  hasActor_id_actors!: Sequelize.BelongsToManyHasAssociationsMixin<actor, actorId>;
  ...
  setFilm_actors!: Sequelize.HasManySetAssociationsMixin<film_actor, film_actorId>;
  addFilm_actor!: Sequelize.HasManyAddAssociationMixin<film_actor, film_actorId>;
  addFilm_actors!: Sequelize.HasManyAddAssociationsMixin<film_actor, film_actorId>;
  createFilm_actor!: Sequelize.HasManyCreateAssociationMixin<film_actor>;
  removeFilm_actor!: Sequelize.HasManyRemoveAssociationMixin<film_actor, film_actorId>;
  removeFilm_actors!: Sequelize.HasManyRemoveAssociationsMixin<film_actor, film_actorId>;
  hasFilm_actor!: Sequelize.HasManyHasAssociationMixin<film_actor, film_actorId>;
  hasFilm_actors!: Sequelize.HasManyHasAssociationsMixin<film_actor, film_actorId>;
  ...
  setFilm_categories!: Sequelize.HasManySetAssociationsMixin<film_category, film_categoryId>;
  addFilm_category!: Sequelize.HasManyAddAssociationMixin<film_category, film_categoryId>;
  addFilm_categories!: Sequelize.HasManyAddAssociationsMixin<film_category, film_categoryId>;
  createFilm_category!: Sequelize.HasManyCreateAssociationMixin<film_category>;
  removeFilm_category!: Sequelize.HasManyRemoveAssociationMixin<film_category, film_categoryId>;
  removeFilm_categories!: Sequelize.HasManyRemoveAssociationsMixin<film_category, film_categoryId>;
  hasFilm_category!: Sequelize.HasManyHasAssociationMixin<film_category, film_categoryId>;
  hasFilm_categories!: Sequelize.HasManyHasAssociationsMixin<film_category, film_categoryId>;
